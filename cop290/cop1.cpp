...
int main(int argc , char* argv[]){
	...
	if(!input2.is_open()) {cout<<"Error in opening Input conv1.txt, check the address or filename" ; return 0;}
	...
	if(!input3.is_open()) {cout<<"Error in opening Input conv2.txt, check the address or filename" ; return 0;}
	...
	if(!input4.is_open()) {cout<<"Error in opening Input fc1.txt, check the address or filename" ; return 0;}
	...
	if(!input5.is_open()) {cout<<"Error in opening Input fc2.txt, check the address or filename" ; return 0;}
